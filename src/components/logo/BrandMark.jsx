// LUDI brand mark — a rounded emerald badge with a bold checkmark (the
...
export default function BrandMark({ size = 96, animate = false, rounded = 0.28 }) {
  const r = 100 * rounded;
  return (
    <svg viewBox="0 0 100 100" width={size} height={size} role="img" aria-label="LUDI">
      <defs>
        <linearGradient id="ludiGrad" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#34D399" />
          <stop offset="100%" stopColor="var(--color-gold)" />
        </linearGradient>
      </defs>
      <rect x="4" y="4" width="92" height="92" rx={r} ry={r} fill="url(#ludiGrad)" />
      <path
