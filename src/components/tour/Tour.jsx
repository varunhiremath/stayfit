...
const STEPS = [
  ...
  { icon: Dumbbell, title: 'Log your workouts', body: 'Tap the green button in the middle of the nav bar to start. Your planned exercises are listed — tap one to open it and log sets, with the plate calculator on hand. Finished ones fold away into Done, each with the time it took. Get interrupted? Your session is saved.' },
