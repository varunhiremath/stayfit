...
Tested utils: units, **bmi**, plateCalc, overload, volume, restStats, oneRepMax, snapshots-free calendar, workoutSession, reminders, reorder, csv, inventory, dateKey, routineName, programs, progression, weekPlanner, routineGenerator, staleRoutine, calories, setDiff, imageResize, **nextSession**, **stretchSession**, **seedStretches** + uiStore. **283 tests.**
